...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OriginStampDocumentation.SchedulerApi();
  });
  ...
  describe('SchedulerApi', function() {
    describe('getNextSchedulingTime', function() {
      it('should call getNextSchedulingTime successfully', function(done) {
        //uncomment below and update the code to test getNextSchedulingTime
        //instance.getNextSchedulingTime(function(error) {
