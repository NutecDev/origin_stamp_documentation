...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OriginStampDocumentation.WebhookApi();
  });
  ...
  describe('WebhookApi', function() {
    describe('getWebhookStatus', function() {
      it('should call getWebhookStatus successfully', function(done) {
        //uncomment below and update the code to test getWebhookStatus
        //instance.getWebhookStatus(function(error) {
    ...
    describe('registerWebhookNotification', function() {
      it('should call registerWebhookNotification successfully', function(done) {
        //uncomment below and update the code to test registerWebhookNotification
        //instance.registerWebhookNotification(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('triggerTimestampWebhook', function() {
      it('should call triggerTimestampWebhook successfully', function(done) {
        //uncomment below and update the code to test triggerTimestampWebhook
        //instance.triggerTimestampWebhook(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
