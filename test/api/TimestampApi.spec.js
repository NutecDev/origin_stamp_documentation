...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OriginStampDocumentation.TimestampApi();
  });
  ...
  describe('TimestampApi', function() {
    describe('createTimestamp', function() {
      it('should call createTimestamp successfully', function(done) {
        //uncomment below and update the code to test createTimestamp
        //instance.createTimestamp(function(error) {
    ...
    describe('getApiKeyUsage', function() {
      it('should call getApiKeyUsage successfully', function(done) {
        //uncomment below and update the code to test getApiKeyUsage
        //instance.getApiKeyUsage(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('getHashStatus', function() {
      it('should call getHashStatus successfully', function(done) {
        //uncomment below and update the code to test getHashStatus
        //instance.getHashStatus(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
