...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OriginStampDocumentation.ProofApi();
  });
  ...
  describe('ProofApi', function() {
    describe('getProof', function() {
      it('should call getProof successfully', function(done) {
        //uncomment below and update the code to test getProof
        //instance.getProof(function(error) {
