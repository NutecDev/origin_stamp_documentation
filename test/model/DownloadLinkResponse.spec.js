...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OriginStampDocumentation.DownloadLinkResponse();
  });
  ...
  describe('DownloadLinkResponse', function() {
    it('should create an instance of DownloadLinkResponse', function() {
      // uncomment below and update the code to test DownloadLinkResponse
      //var instance = new OriginStampDocumentation.DownloadLinkResponse();
      //expect(instance).to.be.a(OriginStampDocumentation.DownloadLinkResponse);
    });
