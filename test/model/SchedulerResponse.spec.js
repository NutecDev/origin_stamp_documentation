...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OriginStampDocumentation.SchedulerResponse();
  });
  ...
  describe('SchedulerResponse', function() {
    it('should create an instance of SchedulerResponse', function() {
      // uncomment below and update the code to test SchedulerResponse
      //var instance = new OriginStampDocumentation.SchedulerResponse();
      //expect(instance).to.be.a(OriginStampDocumentation.SchedulerResponse);
    });

    it('should have the property submissionTime (base name: "submission_time")', function() {
