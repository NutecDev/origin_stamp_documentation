...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OriginStampDocumentation.ManualWebhookRequest();
  });
  ...
  describe('ManualWebhookRequest', function() {
    it('should create an instance of ManualWebhookRequest', function() {
      // uncomment below and update the code to test ManualWebhookRequest
      //var instance = new OriginStampDocumentation.ManualWebhookRequest();
      //expect(instance).to.be.a(OriginStampDocumentation.ManualWebhookRequest);
    });
