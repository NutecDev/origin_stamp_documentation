...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OriginStampDocumentation.DefaultDownloadLinkResponse();
  });
  ...
  describe('DefaultDownloadLinkResponse', function() {
    it('should create an instance of DefaultDownloadLinkResponse', function() {
      // uncomment below and update the code to test DefaultDownloadLinkResponse
      //var instance = new OriginStampDocumentation.DefaultDownloadLinkResponse();
      //expect(instance).to.be.a(OriginStampDocumentation.DefaultDownloadLinkResponse);
    });
