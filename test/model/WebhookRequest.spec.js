...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OriginStampDocumentation.WebhookRequest();
  });
  ...
  describe('WebhookRequest', function() {
    it('should create an instance of WebhookRequest', function() {
      ...
      //var instance = new OriginStampDocumentation.WebhookRequest();
      //expect(instance).to.be.a(OriginStampDocumentation.WebhookRequest);
    });
