...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OriginStampDocumentation.TimestampRequest();
  });
  ...
  describe('TimestampRequest', function() {
    it('should create an instance of TimestampRequest', function() {
      // uncomment below and update the code to test TimestampRequest
      //var instance = new OriginStampDocumentation.TimestampRequest();
      //expect(instance).to.be.a(OriginStampDocumentation.TimestampRequest);
    });
