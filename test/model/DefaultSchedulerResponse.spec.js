...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OriginStampDocumentation.DefaultSchedulerResponse();
  });
  ...
  describe('DefaultSchedulerResponse', function() {
    it('should create an instance of DefaultSchedulerResponse', function() {
      // uncomment below and update the code to test DefaultSchedulerResponse
      //var instance = new OriginStampDocumentation.DefaultSchedulerResponse();
      //expect(instance).to.be.a(OriginStampDocumentation.DefaultSchedulerResponse);
    });
