...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OriginStampDocumentation.UsageResponse();
  });
  ...
  describe('UsageResponse', function() {
    it('should create an instance of UsageResponse', function() {
      // uncomment below and update the code to test UsageResponse
      //var instance = new OriginStampDocumentation.UsageResponse();
      //expect(instance).to.be.a(OriginStampDocumentation.UsageResponse);
    });

    it('should have the property consumedCredits (base name: "consumed_credits")', function() {
      // uncomment below and update the code to test the property consumedCredits
      //var instance = new OriginStampDocumentation.UsageResponse();
      //expect(instance).to.be();
    });

    it('should have the property creditsPerMonth (base name: "credits_per_month")', function() {
      // uncomment below and update the code to test the property creditsPerMonth
      //var instance = new OriginStampDocumentation.UsageResponse();
      //expect(instance).to.be();
    });
