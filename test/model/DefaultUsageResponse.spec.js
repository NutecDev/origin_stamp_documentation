...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OriginStampDocumentation.DefaultUsageResponse();
  });
  ...
  describe('DefaultUsageResponse', function() {
    it('should create an instance of DefaultUsageResponse', function() {
      // uncomment below and update the code to test DefaultUsageResponse
      //var instance = new OriginStampDocumentation.DefaultUsageResponse();
      //expect(instance).to.be.a(OriginStampDocumentation.DefaultUsageResponse);
    });
