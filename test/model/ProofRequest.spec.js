...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OriginStampDocumentation.ProofRequest();
  });
  ...
  describe('ProofRequest', function() {
    it('should create an instance of ProofRequest', function() {
      // uncomment below and update the code to test ProofRequest
      //var instance = new OriginStampDocumentation.ProofRequest();
      //expect(instance).to.be.a(OriginStampDocumentation.ProofRequest);
    });
