...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OriginStampDocumentation.ModelDefault();
  });
  ...
  describe('ModelDefault', function() {
    it('should create an instance of ModelDefault', function() {
      ...
      //var instance = new OriginStampDocumentation.ModelDefault();
      //expect(instance).to.be.a(OriginStampDocumentation.ModelDefault);
    });
