...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OriginStampDocumentation.DefaultTimestampResponse();
  });
  ...
  describe('DefaultTimestampResponse', function() {
    it('should create an instance of DefaultTimestampResponse', function() {
      // uncomment below and update the code to test DefaultTimestampResponse
      //var instance = new OriginStampDocumentation.DefaultTimestampResponse();
      //expect(instance).to.be.a(OriginStampDocumentation.DefaultTimestampResponse);
    });
