...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OriginStampDocumentation.Notification();
  });
  ...
  describe('Notification', function() {
    it('should create an instance of Notification', function() {
      ...
      //var instance = new OriginStampDocumentation.Notification();
      //expect(instance).to.be.a(OriginStampDocumentation.Notification);
    });
