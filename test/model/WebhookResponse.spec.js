...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OriginStampDocumentation.WebhookResponse();
  });
  ...
  describe('WebhookResponse', function() {
    it('should create an instance of WebhookResponse', function() {
      ...
      //var instance = new OriginStampDocumentation.WebhookResponse();
      //expect(instance).to.be.a(OriginStampDocumentation.WebhookResponse);
    });
