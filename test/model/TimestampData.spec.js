...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OriginStampDocumentation.TimestampData();
  });
  ...
  describe('TimestampData', function() {
    it('should create an instance of TimestampData', function() {
      // uncomment below and update the code to test TimestampData
      //var instance = new OriginStampDocumentation.TimestampData();
      //expect(instance).to.be.a(OriginStampDocumentation.TimestampData);
    });
    ...
    it('should have the property submitStatus (base name: "submit_status")', function() {
