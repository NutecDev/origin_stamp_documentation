...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OriginStampDocumentation.SchedulerRequest();
  });
  ...
  describe('SchedulerRequest', function() {
    it('should create an instance of SchedulerRequest', function() {
      // uncomment below and update the code to test SchedulerRequest
      //var instance = new OriginStampDocumentation.SchedulerRequest();
      //expect(instance).to.be.a(OriginStampDocumentation.SchedulerRequest);
    });
