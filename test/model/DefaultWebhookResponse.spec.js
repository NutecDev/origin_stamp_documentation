...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OriginStampDocumentation.DefaultWebhookResponse();
  });
  ...
  describe('DefaultWebhookResponse', function() {
    it('should create an instance of DefaultWebhookResponse', function() {
      // uncomment below and update the code to test DefaultWebhookResponse
      //var instance = new OriginStampDocumentation.DefaultWebhookResponse();
      //expect(instance).to.be.a(OriginStampDocumentation.DefaultWebhookResponse);
    });
