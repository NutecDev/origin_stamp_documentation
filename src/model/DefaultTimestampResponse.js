...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/TimestampResponse'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./TimestampResponse'));
  } else {
    // Browser globals (root is window)
    if (!root.OriginStampDocumentation) {
      root.OriginStampDocumentation = {};
    }
    root.OriginStampDocumentation.DefaultTimestampResponse = factory(root.OriginStampDocumentation.ApiClient, root.OriginStampDocumentation.TimestampResponse);
  }
}(this, function(ApiClient, TimestampResponse) {
  'use strict';
  ...
  /**
   * The DefaultTimestampResponse model module.
   * @module model/DefaultTimestampResponse
   * @version 3.0
   */

  /**
   * Constructs a new <code>DefaultTimestampResponse</code>.
   ...
   * @alias module:model/DefaultTimestampResponse
   * @class
   */
  ...
  /**
   * Constructs a <code>DefaultTimestampResponse</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/DefaultTimestampResponse} obj Optional instance to populate.
   * @return {module:model/DefaultTimestampResponse} The populated <code>DefaultTimestampResponse</code> instance.
   */
   ...
   * @member {module:model/TimestampResponse} data
   */
