...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.OriginStampDocumentation.DefaultWebhookResponse = factory(root.OriginStampDocumentation.ApiClient, root.OriginStampDocumentation.WebhookResponse);
  }
  ...
  /**
   * The DefaultWebhookResponse model module.
   * @module model/DefaultWebhookResponse
   * @version 3.0
   */

  /**
   * Constructs a new <code>DefaultWebhookResponse</code>.
   ...
   * @alias module:model/DefaultWebhookResponse
   * @class
   */
  ...
  /**
   * Constructs a <code>DefaultWebhookResponse</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/DefaultWebhookResponse} obj Optional instance to populate.
   * @return {module:model/DefaultWebhookResponse} The populated <code>DefaultWebhookResponse</code> instance.
   */
