...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/SchedulerResponse'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./SchedulerResponse'));
  } else {
    // Browser globals (root is window)
    if (!root.OriginStampDocumentation) {
      root.OriginStampDocumentation = {};
    }
    root.OriginStampDocumentation.DefaultSchedulerResponse = factory(root.OriginStampDocumentation.ApiClient, root.OriginStampDocumentation.SchedulerResponse);
  }
}(this, function(ApiClient, SchedulerResponse) {
  'use strict';
  ...
  /**
   * The DefaultSchedulerResponse model module.
   * @module model/DefaultSchedulerResponse
   * @version 3.0
   */

  /**
   * Constructs a new <code>DefaultSchedulerResponse</code>.
   ...
   * @alias module:model/DefaultSchedulerResponse
   * @class
   */
  ...
  /**
   * Constructs a <code>DefaultSchedulerResponse</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/DefaultSchedulerResponse} obj Optional instance to populate.
   * @return {module:model/DefaultSchedulerResponse} The populated <code>DefaultSchedulerResponse</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('data')) {
        obj['data'] = SchedulerResponse.constructFromObject(data['data']);
      }
   ...
   * @member {module:model/SchedulerResponse} data
   */
