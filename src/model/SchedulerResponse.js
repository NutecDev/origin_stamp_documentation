...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.OriginStampDocumentation.SchedulerResponse = factory(root.OriginStampDocumentation.ApiClient);
  }
  ...
  /**
   * The SchedulerResponse model module.
   * @module model/SchedulerResponse
   * @version 3.0
   */

  /**
   * Constructs a new <code>SchedulerResponse</code>.
   * DTO which contains nxt submission time.
   * @alias module:model/SchedulerResponse
   * @class
   */
  ...
  /**
   * Constructs a <code>SchedulerResponse</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/SchedulerResponse} obj Optional instance to populate.
   * @return {module:model/SchedulerResponse} The populated <code>SchedulerResponse</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      obj = obj || new exports();

      if (data.hasOwnProperty('submission_time')) {
        obj['submission_time'] = ApiClient.convertToType(data['submission_time'], 'Number');
      }
    }
    return obj;
  }
   ...
   * @member {Number} submission_time
   */
  exports.prototype['submission_time'] = undefined;
