...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.OriginStampDocumentation.DefaultDownloadLinkResponse = factory(root.OriginStampDocumentation.ApiClient, root.OriginStampDocumentation.DownloadLinkResponse);
  }
  ...
  /**
   * The DefaultDownloadLinkResponse model module.
   * @module model/DefaultDownloadLinkResponse
   * @version 3.0
   */

  /**
   * Constructs a new <code>DefaultDownloadLinkResponse</code>.
   ...
   * @alias module:model/DefaultDownloadLinkResponse
   * @class
   */
  ...
  /**
   * Constructs a <code>DefaultDownloadLinkResponse</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/DefaultDownloadLinkResponse} obj Optional instance to populate.
   * @return {module:model/DefaultDownloadLinkResponse} The populated <code>DefaultDownloadLinkResponse</code> instance.
   */
