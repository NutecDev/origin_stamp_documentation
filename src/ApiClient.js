...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.OriginStampDocumentation.ApiClient = factory(root.superagent, root.querystring);
  }
  ...
  var exports = function() {
     ...
     * @type {String}
     * @default https://api.originstamp.org
     */
    this.basePath = 'https://api.originstamp.org'.replace(/\/+$/, '');
